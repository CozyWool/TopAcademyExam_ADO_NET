...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240211141217_FixedOlympiad_ParticipantTable') THEN
    ALTER TABLE "Olympiad_Participant" DROP CONSTRAINT "Olympiad_Participant_pkey";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240211141217_FixedOlympiad_ParticipantTable') THEN
    ALTER TABLE "Olympiad_Participant" ADD CONSTRAINT "Olympiad_Participant_pkey" PRIMARY KEY (id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240211141217_FixedOlympiad_ParticipantTable') THEN
    CREATE UNIQUE INDEX "IX_Olympiad_Participant_participant_id" ON "Olympiad_Participant" (participant_id);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240211141217_FixedOlympiad_ParticipantTable') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20240211141217_FixedOlympiad_ParticipantTable', '8.0.1');
    END IF;
END $EF$;
COMMIT;
